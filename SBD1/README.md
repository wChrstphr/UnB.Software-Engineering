...
- Relaciomanetos binarios ou ternarios que possuem (0,N), não significam que é possivel criar um relacionamento com uma das partes dfaltando. Ex: medico (0,N) - Atende (0,N) Paciente
