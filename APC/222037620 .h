...
void listar_pessoas_cidade() {
    ...
    if (existe_cidade == 1) {
        ...
        printf("Existem %d pessoas cadastradas na cidade %s:\n\n", contador, cidade);
...
void gerar_relatorio () {
    ...
    float sexo_masculino, sexo_feminino;
    ...
    arquivo = fopen("cadastros.txt", "r");
        ...
        printf("Total de pessoas beneficiadas pelo programa: %.0f\n\n", total_pessoas);
        printf("Percentual de 0 a 15 anos: %.2f%%\n", percentual0_15);
        printf("Percentual de 16 a 29 anos: %.2f%%\n", percentual16_29);
        printf("Percentual de 30 a 49 anos: %.2f%%\n", percentual30_49);
        printf("Percentual de 50 a 60 anos: %.2f%%\n", percentual50_60);
        printf("Percentual de 60 anos ou mais: %.2f%%\n", percentualAcima_60);
